    ...
    public function handle()
    {
        ...
        try {
            ...
            foreach ($allTables as $table) {
                if ($table == 'tbl_country' || $table == 'tbl_state' || $table == 'tbl_district' || $table == 'tbl_module' || $table == 'tbl_package' || $table == 'tbl_organization' || $table == 'tbl_designation' || $table == 'tbl_department')
                    continue;
