...
class NepalicontentController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $html = view("dftqc.setting.nepalicontent.ajax.index", compact('data'))->render();
            return response()->json(['status' => true, 'content' => $html], 200);
        }
        return view("dftqc.setting.nepalicontent.ajax_index", compact('data'));
    }

    public function create(Request $request)
    {
        if ($request->ajax()) {
            $html = view("dftqc.setting.nepalicontent.ajax.create")->render();
            return response()->json(['status' => true, 'content' => $html], 200);
        }
        return view("dftqc.setting.nepalicontent.create");
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        if ($request->ajax()) {
            $html = view("dftqc.setting.nepalicontent.ajax.show", compact('data'))->render();
            return response()->json(['status' => true, 'content' => $html], 200);
        }
        return view("dftqc.setting.nepalicontent.show", compact('data'));
    }
    ...
    public function edit(Request $request, $id)
    {
        $data = Nepalicontent::findOrFail($id);
        if ($request->ajax()) {
            $html = view("dftqc.setting.nepalicontent.ajax.edit", compact('data'))->render();
            return response()->json(['status' => true, 'content' => $html], 200);
        }
        return view("dftqc.setting.nepalicontent.edit", compact('data'));
    }
    ...
    public static function getAjaxContent($type, $id = '', $option = '')
    {
        switch ($type) {
            case 'index':
                ...
                return view("dftqc.setting.nepalicontent.ajax.index", compact('data'))->render();
                break;
            case 'create':
                return view("dftqc.setting.nepalicontent.ajax.create")->render();
                break;
            case 'edit':
                $data = Nepalicontent::findOrFail($id);
                return view("dftqc.setting.nepalicontent.ajax.edit", compact('data'))->render();
                break;
            default:
                return 'Not Found';
        }
    ...
    public function getDatabaseBackupFiles()
    {
        ...
        return view('dftqc.setting.backup.index',compact('backups'));
    }
