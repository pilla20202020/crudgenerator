...
class PermissionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view("dftqc.setting.permission.ajax_index", compact('data'));
    }

    public function create(Request $request)
    {
        if ($request->ajax()) {
            $html = view("dftqc.setting.permission.ajax.create")->render();
            return response()->json(['status' => true, 'content' => $html], 200);
        }
        return view("dftqc.setting.permission.create");
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view("dftqc.setting.permission.show", compact('data'));
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view("dftqc.setting.permission.edit", compact('data'));
    }
