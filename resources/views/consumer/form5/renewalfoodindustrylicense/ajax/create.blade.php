                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-between flex-wrap gap g-2">
                        <div class="nk-block-head-content">
                            <h2 class="nk-block-title">{{ __('lang.Renewalfoodindustrylicense') }}</h2>
                            <nav>
                ...
                <div class="nk-block">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{route('form5.renewalfoodindustrylicense.store')}}" id="storeCustomForm" class="row g-3">
    @csrf
    <div class="row">
...
<input type="hidden" id="temp_desc_all" value="0" name="temp_desc_all">
        ...
        <div class="col-lg-12" id="paramaterfield">
            ...
            <div class="input-group" id="replaceparamater">
                <input type="text" class="form-control" aria-describedby="button-addon1" name="parameter[]" id="paramater">
        ...
        <div class="col-lg-12">
            <div class="form-check my-2"> <input class="form-check-input" type="checkbox" value="" id="issueDate"> 
            <label class="form-check-label" for="issueDate"> जारी भएको अनुज्ञापत्र सक्कली प्रति </label>
            <input class="form-control-sm mx-2" type="file" name="issueDateImage" id="issueDateImage"></div>
        </div>

        <div class="col-lg-12">
            <div class="form-check my-2"> <input class="form-check-input" type="checkbox" value="" id="receipt">
             <label class="form-check-label" for="receipt"> राजस्व दस्तुर बुझाएको नगदी रशिद</label>
             <input class="form-control-sm mx-2"  type="file" name="receiptImage" id="receiptImage"></div>
        </div>
        <div class="col-lg-12">
            <div class="form-check my-2"> <input class="form-check-input" type="checkbox" value="" id="production"> 
            <label class="form-check-label" for="production"> उत्पादिन खाद्य पदार्थ बिवरणमा थपघट गर्नु परेमा सोको बिवरण</label>
            <input class="form-control-sm mx-2"  type="file" name="productionImage" id="productionImage"></div>
        </div>
        <div class="col-lg-12">
            <div class="form-check my-2"> <input class="form-check-input" type="checkbox" value="" id="label"> 
            <label class="form-check-label" for="label">उत्पादिन खाद्य वस्तुको लेवल नमुना १ / १ प्रति</label>
            <input class="form-control-sm mx-2" type="file" name="labelImage" id="labelImage"></div>
        </div>
        <div class="col-lg-12">
            <div class="form-check my-2"> <input class="form-check-input" type="checkbox" value="" id="sample"> 
            <label class="form-check-label" for="sample">उत्पादिन खाद्य वस्तुको नमुना</label></div>
        </div>
        <div class="col-lg-12 my-2">
            <div class="form-check"> <input class="form-check-input" type="checkbox" value="" id="photocopy">
             <label class="form-check-label" for="photocopy">घरेलु तथा साना उद्योग कार्यालयको उद्योग दर्ता प्रमाण पत्रको फोटोकपी / छाँयाप्रति</label>
             <input class="form-control-sm mx-2" type="file" name="photocopyImage" id="photocopyImage"></div>
        </div>
