...
<div class="offcanvas-header border-bottom border-light">
        <h5 class="offcanvas-title" id="offcanvasTopLabel">{{ __('lang.ShowNewlicenseissue') }}</h5><button type="button" class="btn-close"
        ...
        <div class="nk-block-head-content w-100">
            ...
            <div class="card w-100">
                ...
                <!-- header start -->
                    ...
                    <p class="col-12 text-center subject">विषयः- खाद्य उद्योग अनुज्ञापत्र (नया जारी) पाउँ बारे ।</p>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="label">
                                        घ) उद्योगपतिको अधिकारिक पत्र (उद्योगको कारबाहीमा जिम्मा लिने व्यक्ति उद्योगपति नभएमा) </label>
                                </div>
                                <div class="form-check">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="household">
                                        च) प्याक गरिएका खाद्य पदार्थको लेबल १/१ प्रति लोगो वा ब्रान्ड भएमा सो अनुरुपको  </label>
                                </div>
                                    <label class="form-check-label" for="household">
