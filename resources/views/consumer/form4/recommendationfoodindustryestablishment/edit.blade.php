    ...
    <div class="nk-content">
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            ...
                            <div class="nk-block-head-content">
                                <ul class="d-flex">
                                    <li>
                                        <a href="{{ route('form4.recommendationfoodindustryestablishment.index') }}"
        ...
        <div class="col-lg-6" id="adddescription">
            ...
            <input type="hidden" id="temp_desc" value="0" name="temp_desc">
                                        ...
                                        <div class="col-lg-6">{{createText("techincialSkills","techincialSkills","TechincialSkills",'',$data->techincialSkills)}}</div>
                                        <div class="col-lg-6">
