<form action="{{ route('form7.newlicenseissue.store') }}" id="storeCustomForm" enctype="multipart/form-data" class="row g-3">
    @csrf
    <div class="row">
        <div class=" col-lg-4 col-sm-6">{{ createText('industryName', 'industryName', 'Industry Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryAddressTol', 'industryAddressTol', 'Industry Address Tol') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('MunicipalityVDC', 'MunicipalityVDC', 'Municipality') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryDistrict', 'industryDistrict', 'Industry District') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryAddress', 'industryAddress', 'Industry Address') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryType', 'industryType', 'Industry Type') }}
        </div>
        ...
        <div class=" col-lg-4 col-sm-6">{{ createText('fatherName', 'fatherName', 'Father Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('grandFatherName', 'grandFatherName', 'Grandfather Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('permanentAddress', 'permanentAddress', 'Permanent Address') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('temporaryAddress', 'temporaryAddress', 'Temporary Address') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('foodNameOne', 'foodNameOne', 'Food Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('foodNameTwo', 'foodNameTwo', 'Food Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('foodNameThree', 'foodNameThree', 'Food Name') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('packingSizeOne', 'packingSizeOne', 'Packing Size') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('packingSizeTwo', 'packingSizeTwo', 'Packing Size') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('packingSizeThree', 'packingSizeThree', 'Packing Size') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('brandOne', 'brandOne', 'Brand') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('brandTwo', 'brandTwo', 'Brand') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('brandThree', 'brandThree', 'Brand') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryMachineOne', 'industryMachineOne', 'Industry Machine') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryMachineTwo', 'industryMachineTwo', 'Industry Machine') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryMachineThree', 'industryMachineThree', 'Industry Machine') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryMachineFour', 'industryMachineFour', 'Industry Machine') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryManageOne', 'industryManageOne', 'Industry Manage') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryManageTwo', 'industryManageTwo', 'Industry Manage') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryManageThree', 'industryManageThree', 'Industry Manage') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryManageFour', 'industryManageFour', 'Industry Manage') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('labManage', 'labManage', 'Lab Manage') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('industryCost', 'industryCost', 'Industry Cost') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('labWorksOne', 'labWorksOne', 'Lab Works') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('labWorksTwo', 'labWorksTwo', 'Lab Works') }}
        </div>
        <div class=" col-lg-4 col-sm-6">{{ createText('labWorksThree', 'labWorksThree', 'Lab Works') }}
        </div>


        <div class=" col-lg-4 col-sm-6">{{ createText('userName', 'userName', 'User Name') }}
    ...
    <div class="col-lg-6">{{ createDate('date', 'date', 'Date') }}
        ...
        <div class="col-lg-3">{{ createNumber('industryCost', 'industryCost', 'Industry Cost') }}
        </div>
        ...
        <div class=" col-lg-4 col-sm-6">{{ createText('userAddress', 'userAddress', 'User Address') }}
        </div>
        ...
        <div class="col-md-12"><?php createButton('btn-primary btn-image', '', 'Submit'); ?>
        </div>
</form>
<script>
