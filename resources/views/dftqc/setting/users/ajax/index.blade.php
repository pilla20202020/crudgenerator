            ...
            <tr>
                ...
                <td class="tb-col">
                    <ul class="d-flex flex-wrap ">
                        <li><a href="{{ route('setting.users.show', [$item->id]) }}" type="button"
                                class="btn btn-color-success btn-hover-success btn-icon btn-soft"><em
                                    class="icon ni ni-eye"></em></a></li>
                        <li><a href="{{ route('setting.users.edit', [$item->id]) }}" type="button"
                        ...
                        <li><button type="button" data-route="{{ route('setting.users.destroy', [$item->id]) }}"
