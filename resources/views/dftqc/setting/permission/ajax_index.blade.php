                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Permission List</h1>
                                    <nav>
                                        <ol class="breadcrumb breadcrumb-arrow mb-0">
                                            <li class="breadcrumb-item"><a href="#">Permission</a></li>
                                            <li class="breadcrumb-item"><a href="#">Permission Manage</a></li>
                            ...
                            <table class="datatable-init table" data-nk-container="table-responsive" id="CustomTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="tb-col"><span class="overline-title">Permission Name</span></th>
                                        <th class="tb-col"><span class="overline-title">Alias</span></th>
                                        <th class="tb-col"><span class="overline-title">Module Name</span></th>
                                        <th class="tb-col"><span class="overline-title">Group Name</span></th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td class="tb-col">{{ $item->moduleName }}</td>
                                            <td class="tb-col">{{ $item->group_name }}</td>
