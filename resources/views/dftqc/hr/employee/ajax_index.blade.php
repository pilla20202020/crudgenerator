                            ...
                            <table class="datatable-init table" data-nk-container="table-responsive" id="CustomTable">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th class="tb-col"><span class="overline-title">{{ __('lang.Department Name') }}</span></th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb-col">
                                                    <div class="media-text"> 
                                                      <div class="media-header">{{$item->firstName}} {{$item->lastName}}</div>  
                                                    <span class="small text">{{ $item->emailAddress }}</span></div>
                                                </div>
                                            </td>
