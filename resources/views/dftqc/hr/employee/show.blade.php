                        ...
                        <div class="nk-block-head-between flex-wrap gap g-2 align-items-start">
                            <div class="nk-block-head-content">
                                <div class="d-flex flex-column flex-md-row align-items-md-center">
                                    <div class="media media-huge media-circle"><img src="{{$data->profilePhoto}}" class="img-thumbnail" alt=""></div>
                                    <div class="mt-3 mt-md-0 ms-md-3">
                                        <h3 class="title mb-1">{{ $data->firstName }}</h3><span class="small">{{$data->designation_id}}</span>
                                        <ul class="nk-list-option pt-1">
                                            <li><em class="icon ni ni-map-pin"></em><span class="small">{{$data->emailAddress}}</span></li>
                                            <li><em class="icon ni ni-building"></em><span class="small">Bibhuti Solutions</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                                ...
                                                <div class="offcanvas-body" data-simplebar>
                                                    ...
                                                    <form>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12"> <label for="remarks" class="form-label col-form-label"> Remarks </label>
                                                                <div class="form-control-wrap">
                                                                    {{createTextarea('remarks','remarks','3','','')}}
                                                                </div>
            ...
            var tst = `<div class="form-group row d-flex align-items-end appended-row-edu">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="d-flex gap-3">
                            <input id="thumbnail` + append + `" class="form-control" type="text" name="image_path[]" readonly>
                            <button id="lfm` + append + `" data-input="thumbnail` + append + `" data-preview="holder` +
                append + `" class="lfm` + append + ` btn icon-left btn-primary ml-2 d-flex btn-sm">
