...
<td class="tb-col">
                                                ...
                                                <li>    
                                                    {!! actionCanvasButton("","btn-showCanvas","showoffcanvas","eye",'master.departmenttype.show',$item->departmenttype_id) !!}
                                                </li>
                                               <li> 
                                                        {!! actionCanvasButton("","btn-editCanvas","editoffcanvas","edit",'master.departmenttype.edit',$item->departmenttype_id) !!}
                                                </li>
                                                <li>{!! deleteCanvasButton("","btn-hover-danger",'master.departmenttype.destroy',$item->departmenttype_id) !!}</li>
                                               </ul> </td>
                                               </tr>
