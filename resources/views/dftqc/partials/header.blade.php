<div class="nk-header nk-header-fixed noprint">
    <div class="container-fluid">
        <div class="nk-header-wrap">
            <div class="nk-header-logo ms-n1">
                ...
                <div class="nk-navbar-toggle me-2 noprint"><button
                    ...
                    <div class="logo-wrap noprint"><svg class="logo-svg" viewBox="0 0 174 34" fill="none"
                            ...
                            <defs>
                                ...
                                <linearGradient id="paint1_linear_3467_17210" x1="26" y1="-2.50127"
                                    x2="14.4905" y2="28.0095" gradientUnits="userSpaceOnUse">
            ...
            <nav class="nk-header-menu nk-navbar noprint">

                <ul class="nk-nav">


                    @role('super-super-admin')
                        <li class="nk-nav-item "><span class="nk-nav-text">
                                <h2 class="nk-block-title py-5 text-uppercase text-uppercase">Welcome,
                                    {{ auth()->user()->name }}</h2>
                            </span>

                        </li>
                        <li class="nk-nav-item "><span class="nk-nav-text"> </span></li>
                    @endrole
                </ul>

            </nav>
            <div class="nk-header-tools noprint">
