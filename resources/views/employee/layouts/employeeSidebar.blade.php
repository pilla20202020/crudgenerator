            ...
            <div class="nk-sidebar-menu" data-simplebar>
                ...
                <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub">
                            ...
                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">Industry Establish Recomendation</span></a></li>

                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">New License Issue</span></a></li>

                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">Licensing Food
                                        Industry</span></a>
                            </li>
                            <!-- form 5 according to paper -->
                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">License Inspection
                                        Branch</span></a>
                            </li>

                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">Renewal
                                        Foodindustry License</span></a>
                            </li>

                            <li class="nk-menu-item"><a href="#" class="nk-menu-link"><span class="nk-menu-text">Regarding Issuance
                                        License</span></a>
                            </li>
                        </ul>
