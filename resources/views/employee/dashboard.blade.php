    ...
    <div class="container-fluid">
        <div class="nk-content-inner">
            <div class="nk-content-body">
                ...
                <div class="row g-gs">
                <div class="col-sm-12 col-xl-12 col-xxl-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title-group align-items-start">
                                    <div class="card-title">
                                        <h4 class="title">Total Latest Industry Establishment Recommendation</h4>
                                    </div>
                    ...
                    <div class="col-sm-6 col-xl-6 col-xxl-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title-group align-items-start">
                                    <div class="card-title">
                                        <h4 class="title">Total Latest Industry Establishment Recommendation Approved</h4>
                                    </div>
                    ...
                    <div class="col-sm-6 col-xl-6 col-xxl-4">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title-group align-items-start">
                                    <div class="card-title">
                                        <h4 class="title">Total Latest Industry Establishment Recommendation Rejected</h4>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body flex-grow-0 py-2">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h5 class="title">Latest Industry Establishment Recommendation</h5>
                                    </div>
                                </div>
                            </div>
